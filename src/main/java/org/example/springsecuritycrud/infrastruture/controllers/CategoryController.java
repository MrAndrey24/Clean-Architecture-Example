...
import org.example.springsecuritycrud.infrastruture.dto.CategoryDTO;
import org.example.springsecuritycrud.infrastruture.dto.GenericResponse;
import org.example.springsecuritycrud.domain.entities.Category;
import org.example.springsecuritycrud.application.service.CategoryService;
...
public class CategoryController {
    ...
    public ResponseEntity<GenericResponse> createCategory(@RequestBody Category newCategory) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.CREATED).body(new GenericResponse(new CategoryDTO(newId)));
        }catch (Exception e){
