...
import org.example.springsecuritycrud.infrastruture.dto.LoginResponse;
...
public class AuthRestController {
    ...
    public ResponseEntity<LoginResponse> authenticate(@RequestBody User user) {
        ...
        Optional<User> foundedUser = IUserRepositoryImpl.findByEmail(user.getEmail());
    ...
    public ResponseEntity<?> registerUser(@RequestBody User user) {
        ...
        User savedUser = IUserRepositoryImpl.save(user);
